...
<style>
	body{
		background: linear-gradient(145deg, #FF3252, dodgerblue);
	}
#inp{
   border-radius:5px; 
			...
			<div class="">
				<div class="registration">
							...
							<div id="den" class="signin-form profile">
								<h2 style="color:#fff;font-family:Comic Sans MS;">REYNANCE ADMIN</h2>
					...
					<p>© 2021 Reynance. All Rights Reserved </a> </p>
					</div>						
				</div>
			</div>
