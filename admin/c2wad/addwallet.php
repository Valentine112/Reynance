...
$usdt = $link->real_escape_string($_POST['usdt']);




    $sql = "UPDATE admin SET ewallet='$ewallet', bwallet='$bwallet',pm='$pm', usdt='$usdt' WHERE email='$email'";
   ...
   $bw="cant find wallet";
    $an="cant find wallet";
     ...
     <div class="form-group">
      ...
      <div class="form-group">
           <label>Shiba Wallet</label>
        <input type="text" name="pm" value="<?php echo $an ;?>" placeholder="Perfect Money ID"   class="form-control">
      </div>

      <div class="form-group">
           <label>USDT Wallet</label>
        <input type="text" name="usdt" value="<?php echo $usdt ;?>" placeholder="USDT wallet"   class="form-control">
      </div>
