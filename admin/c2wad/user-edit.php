...
if(isset($_SESSION['uid'])){
  ...
  $sql= "SELECT * FROM users WHERE email = '$email'";
    ...
    if(isset($_POST['edit'])){
      ...
      $sql1 = "UPDATE users SET fname='$fname',lname='$lname',username='$username', email='$emails',password='$password', initial_balance = '0', walletbalance='$walletbalance', refbonus='$refbonus', refcode='$refcode', profit='$profit', pname='$pname', phone='$phone', country='$country', address='$address'       WHERE email='$email'";
