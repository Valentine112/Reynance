      ...
      <ul class="sidebar-menu" data-widget="tree" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!--<li><a href="><i class="fa fa-send"></i> Deposited Orders</a></li>-->
            <li class="treeview">
              <a href="#">
                <i class="fa fa-archive"></i>
                <span>Deposited Orders</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-down pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                ...
                <li><a href="deposit.php?token=btc"><i class="fa fa-users"></i>Bitcoin</a></li>
                
                <li><a href="deposit.php?token=eth"><i class="fa fa-users"></i>Ethereum</a></li>
                
                <li><a href="deposit.php?token=usdt"><i class="fa fa-users"></i>USDT</a></li>

                <li><a href="deposit.php?token=shiba"><i class="fa fa-users"></i>SHIBA</a></li>
