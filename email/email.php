<?php
    ...
    function email_body() : string {
        $body = '
            ...
            <p style="margin: 0; font-size: 12px; text-align: center;"><span style="font-size:28px;"><strong>MACROUNIQUE</strong></span></p>
            </div>
            </div>
            </td>
            </tr>
            ...
            <p style="margin: 0; font-size: 16px;">Thanks for signing up to Macrounique. From now on you are part of the family and we promise that you would not regret joining us after we spoil you with our special packages that to help boost your income and make you a professional investor.</p>
            <p style="margin: 0; font-size: 16px; mso-line-height-alt: 16.8px;"> </p>
            ...
            <p style="margin: 0; font-size: 12px; text-align: center;">copyright 2021 macrounique</p>
            </div>
            </div>
            </td>
            </tr>
    ...
    function forgot_email(string $token) : string {
        $body = '
            ...
            <p style="margin: 0; font-size: 16px;">Hi there,</p>
            <p style="margin: 0; font-size: 16px; mso-line-height-alt: 16.8px;"> </p>
            <p style="margin: 0; font-size: 16px;">Please follow this link to <a href="https://macrounique.co/new-pass.php?'.$token.'">change your password</a></p>
            <p style="margin: 0; font-size: 16px; mso-line-height-alt: 16.8px;"> </p>
